        ...
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0">
          ...
          >
            ...
            <h3 className="h3 mb-4">
              Saya Seorang Web Developer Sudah Berkecimpung Sejak Tahun 2024
            </h3>
            <p className="mb-6">
              Saya sudah  berkecimpung di dunia programming ini dengan
              ...
              <span className="text-accent">react.js</span> tapi jika kalian
            ...
            <div className="flex gap-x-6 smm:gap-x-2 lg:gap-x-10 mb-12">
              <div>
                <div className="text-[40px] font-tertiary text-gradient mb-2">
                  {ketikaDiLihat ? (
                    <Penghitung start={0} end={3} duration={3} />
                  ) : null}
                </div>
              ...
              <div>
                <div className="text-[40px] font-tertiary text-gradient mb-2">
                  {ketikaDiLihat ? (
                    <Penghitung start={0} end={2} duration={3} />
                  ) : null}
                </div>
